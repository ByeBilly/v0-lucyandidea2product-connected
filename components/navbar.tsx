    ...
    <nav className="fixed top-0 w-full z-50 bg-slate-900/80 backdrop-blur-xl border-b border-slate-700/50">
      <div className="container mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <Link href="/mform" className="text-slate-300 hover:text-white transition-colors duration-200 font-medium">
            mform
          </Link>
          <Link href="/gallery" className="text-slate-300 hover:text-white transition-colors duration-200 font-medium">
            Gallery
          </Link>
          <Link
            href="/task/history"
