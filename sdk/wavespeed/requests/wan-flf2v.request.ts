...
const WanFlf2vSchema = z.object({
  ...
  seed: z
    ...
    .optional()
    .default(-1)
    .describe("Random seed for reproducibility. If None, a random seed is chosen."),
  num_frames: z
    .number()
    .int()
    .min(81)
    ...
    .optional()
    .default(81)
    .describe("Frames per second of the generated video. Must be between 5 to 24."),
  frames_per_second: z
    .number()
    .int()
    .min(5)
