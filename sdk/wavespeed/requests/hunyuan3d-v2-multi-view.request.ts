...
const Hunyuan3dV2MultiViewSchema = z.object({
  ...
  textured_mesh: z
    .boolean()
    .describe("If set true, textured mesh will be generated and the price charged would be 3 times that of white mesh.")
    .default(false),
})
...
export class Hunyuan3dV2MultiViewRequest extends BaseRequest<typeof Hunyuan3dV2MultiViewSchema> {
  ...
  static create(
    ...
    request.data = {
      ...
      octree_resolution: params?.octree_resolution ?? 256,
      textured_mesh: params?.textured_mesh ?? false,
    }
    return request
  }
