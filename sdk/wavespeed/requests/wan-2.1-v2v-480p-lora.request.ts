...
const Wan21V2v480pLoraSchema = z.object({
  ...
  prompt: z
    ...
    .describe(
      "The text to be converted to speech. Supports speaker tags like [S1], [S2] and non-verbal cues like (laughs)",
    ),
...
export class Wan21V2v480pLoraRequest extends BaseRequest<typeof Wan21V2v480pLoraSchema> {
  ...
  static create(
    ...
    request.data = {
      ...
      loras: loras ?? [{ path: "motimalu/wan-flat-color-v2", scale: 1 }],
